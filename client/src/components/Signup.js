...
function Signup({ setUser, user }) {
  ...
  const errorElements = errors.errors.map((error) => (
    <div key={error} className="alert alert-danger form-font-size mx-auto w-50">
      - {error}
    </div>
  ));
    ...
    <div className="mx-auto w-50 text-center">
      <form onSubmit={onSignup} className="align-items-center form-styles">
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Name">
            Name:
          </span>
          <input
            type="text"
        ...
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Birthday">
            Birthday:
          </span>
          <input
            type="date"
        ...
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Email">
            Email:
          </span>
          <input
            type="email"
        ...
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Username">
            Username:
          </span>
          <input
            type="text"
        ...
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Password">
            Password:
          </span>
          <input
            type="password"
        ...
        <div className="input-group mb-3">
          <span className="input-group-text form-font-size" aria-label="Repeat_password">
            Repeat Password:
          </span>
          <input
            type="password"
            ...
            onChange={(e) => updateForm(e, "password_confirmation")}
